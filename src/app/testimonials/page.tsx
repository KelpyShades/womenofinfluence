            ...
            <AnimatedSection key={t.name} delay={i * 0.1}>
              <div className="flex flex-col h-full border-t border-border/40 pt-8">
                ...
                <div className="flex items-center gap-4">
                  <Image src={t.image} alt={t.name} width={48} height={48} className="w-12 h-12 rounded-full object-cover grayscale" />
                  <div>
            ...
            <AnimatedSection key={v.title} delay={i * 0.1}>
              <div className="group cursor-pointer">
                <div className="relative aspect-4/5 overflow-hidden mb-6 border border-border/40">
                  <Image src={v.image} alt={v.title} width={600} height={750} className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" />
