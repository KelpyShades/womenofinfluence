...
const Gallery = () => {
  ...
  const defaultItems: GalleryRecord[] = [
    { _id: "1", type: "image", url: "https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&q=80", caption: "Cohort 4 Graduation", category: "Events" },
    { _id: "2", type: "video", url: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80", caption: "Leading with Empathy", category: "Workshops" },
    { _id: "3", type: "award", url: "https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&q=80", caption: "WIA 2026 Awards", category: "Awards" },
    { _id: "4", type: "image", url: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?auto=format&fit=crop&q=80", caption: "Networking Mixer", category: "Community" },
    { _id: "5", type: "image", url: "https://images.unsplash.com/photo-1551836022-d5d88e9218df?auto=format&fit=crop&q=80", caption: "Business Pitch Day", category: "Events" },
    { _id: "6", type: "video", url: "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&q=80", caption: "Alumni Spotlight", category: "Interviews" },
    { _id: "7", type: "award", url: "https://images.unsplash.com/photo-1541339907198-e08756dedf3f?auto=format&fit=crop&q=80", caption: "Outstanding Leadership", category: "Awards" },
    { _id: "8", type: "image", url: "https://images.unsplash.com/photo-1556761175-5973dc0f32b7?auto=format&fit=crop&q=80", caption: "Mentorship Session", category: "Mentorship" },
  ];

  const items = gallery && gallery.length > 0 ? gallery : defaultItems;
