...
const categories = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "A powerful read on identity, divine purpose, and stepping into the fullness of who God has called you to be.",
      },
      {
        title: "Rich Dad Poor Dad",
        description:
          "Foundational financial literacy that every woman in the Business & Finance pillar &mdash; and beyond &mdash; should have in her library.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description:
          "Practical strategies for building a life and career you love &mdash; from mindset shifts to business growth, delivered with energy and faith.",
      },
      {
        title: "Called & Caffeinated",
        description:
          "For the woman navigating purpose, faith, and leadership. Each episode is a cup of clarity for women who know they are called to more.",
      },
    ],
  },
];
                  ...
                  {cat.items.map((item) => (
                    ...
                    >
                      ...
                      <div className="space-y-1">
                        <a
                          href="#"
                          className="font-display font-medium text-lg text-foreground group-hover:text-plum transition-colors block"
                        >
                          {item.title}
                        </a>
