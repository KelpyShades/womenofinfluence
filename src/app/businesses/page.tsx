            ...
            <AnimatedSection key={b.name} delay={i * 0.1}>
              <div className="group flex flex-col md:flex-row gap-8">
                ...
                <div className="md:w-1/2 flex flex-col justify-center">
                  ...
                  {b.website && b.website !== "#" && (
                    <a href={b.website} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-4 text-xs tracking-widest uppercase border-b border-plum pb-1 hover:text-plum transition-colors w-max">
